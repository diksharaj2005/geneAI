        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-col-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            <div className="flex flex-col items-center justify-center space-y-2">
              <h3 className="text-4xl font-bold">50+
              </h3>
              <p className="text-muted-foreground">Industries Covered</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <h3 className="text-4xl font-bold">1000+
              </h3>
              <p className="text-muted-foreground">Industries Questions</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <h3 className="text-4xl font-bold">95%
              </h3>
...
return (
 ...
 <section className="w-full mb-15 ">
        <div className=" mx-auto py-24 rounded-lg bg-gradient-to-tr from-gray-200 via-gray-400 to-gray-50">
